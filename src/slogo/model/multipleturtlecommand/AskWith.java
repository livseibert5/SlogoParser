...
/**
 * AskWith is the Command that runs a command block on turtles matching the
 * given condition.
 *
...
public class AskWith implements Command {
  ...
  /**
   * Updates active turtles list to be the list of turtles that meets the condition criteria,
   * runs the commands on these turtles, then reverts the active list to its previous state.
   *
