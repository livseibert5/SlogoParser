...
/**
 * SetPalette is the Command that lets the user define a color by inputting the rbg values and an
 * index for the color to be added to
 *
 * @author Rachel Luria
 */
public class SetPalette implements Command {
  ...
  /**
   * Sets the turtle's list of color's at a specified index to the specified rgb color
   *
