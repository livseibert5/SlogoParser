...
/**
 * SetTowards is the Command subclass that lets the user specify a coordinate that it wants the
 * turtle to face, and then sets the turtle's orientation to face this location.
 *
